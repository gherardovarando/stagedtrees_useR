...
```
.center[
```{r, echo = FALSE, fig.alt="Plot of the staged event tree obtained for the simulated Lefrancq 2021 data. The order of the variables is: Sex, Age, ICU, Death." }
...
```{r, fig.align='center', fig.width=10, fig.height =5, fig.alt="Plot of the staged event tree for the simulated Lefrancq 2021 data on the left and bar plot for the probabilities of death given the history of the patient for the three stages learnt."}
par(mfrow = c(1,2))
